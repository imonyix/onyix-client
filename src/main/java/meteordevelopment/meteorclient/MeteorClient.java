...
public class MeteorClient implements ClientModInitializer {
    public static final String MOD_ID = "onyix-client";
    public static final ModMetadata MOD_META;
    public static final String NAME;
    public static final Version VERSION;
    public static final String BUILD_NUMBER;

    public static final String CLIENT_NAME = "Onyix";
    public static final String CLIENT_VERSION = "1.2";
    public static final String CLIENT_WATERMARK = "Made By onyix";
    ...
    public void onInitializeClient() {
        ...
        LOG.info("Initializing {} v{} - {}", CLIENT_NAME, CLIENT_VERSION, CLIENT_WATERMARK);
        LOG.info("OnyixGUI by Onyix | Minecraft 26.1.2 | Java 25");
        ...
        AntiCheatDetector.INSTANCE.init();
