...
public class WOnyixDropdown<T> extends WDropdown<T> implements OnyixWidget {
    public WOnyixDropdown(T[] values, T value) {
        super(values, value);
    }
    ...
    private static class WRoot extends WDropdownRoot implements OnyixWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            OnyixGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements OnyixWidget {
        @Override
